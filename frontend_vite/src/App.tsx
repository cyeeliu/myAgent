...
function AppContent() {
  ...
  useEffect(() => {
    const disabled: Record<MainNavKey, boolean> = {
      chat: false,
      skills: false,
      agents: false,
      sessions: false,
      configpanel: false,
      teams: !FEATURE_TEAMS_UI,
      heartbeat: !FEATURE_HEARTBEAT_UI,
      cron: !FEATURE_CRON_UI,
      channels: !FEATURE_CHANNELS_UI,
      extensions: !FEATURE_EXTENSIONS_UI,
  ...
  return (
    <div className={`shell ${sidebarCollapsed ? 'shell--collapsed' : ''}`} data-testid="app-shell" data-session-id={sessionId}>
      ...
      <main className={`content ${isTeamAreaExpanded ? 'content--team-expanded' : ''}`}>
        ...
        {FEATURE_BROWSER_UI && activeNav === 'browserpanel' && (
          <div className="app-section">
